...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MetricKey'
        db.create_table('user_metrics_metrickey', (
        ...
        db.send_create_signal('user_metrics', ['MetricKey'])


    def backwards(self, orm):
        
        # Deleting model 'MetricKey'
        db.delete_table('user_metrics_metrickey')
    ...
    models = {
        ...
        'user_metrics.metrickey': {
            'Meta': {'object_name': 'MetricKey'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
